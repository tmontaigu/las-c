...
#include <stdint.h>
    ...
    las_error_t
    las_reader_open_buffer(const uint8_t *buffer, uint64_t size, las_reader_t **out_reader);
    ...
    las_error_t
    las_reader_read_many_next_raw(las_reader_t *self, las_raw_point_t *points, uint64_t num_points);
